...
type AsyncMethodNames<PluginInterface> = {
  [K in MethodNames<PluginInterface>]: `${K extends Extract<
    keyof PluginInterface,
    string
  >
    ? K
    : never}Async`;
 ...
 */
export type AsyncPlugin<BasePlugin extends Plugin<BasePlugin>> =
  PromisifiedInterface<GenerateAsyncMethods<BasePlugin>>;
