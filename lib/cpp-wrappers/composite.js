...
const { BLEND_MODE_MAP, JimpConstants } = require('../../packages/jimp-native/lib/constants');
...
module.exports = {
    composite (src, x, y, options = {}, cb) {
        ...
        if (!(src instanceof this.constructor)) {
            return throwError.call(this, 'The source image must be a Jimp/JimpNative image', cb);
        }
        ...
        try {
            nativeAddon.composite(
                ...
                opacitySource !== undefined ? opacitySource : 1.0,
